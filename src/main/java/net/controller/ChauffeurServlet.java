...
/**
 * Servlet implementation class ChauffeurServlet
 */
@WebServlet("/ChauffeurServlet")
public class ChauffeurServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/ChauffeursList.jsp");
